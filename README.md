...
| `mulle-c11-rotate.h`      | portable bit rotation functions that compile to `ror`/`rol` instructions
| `mulle-c11-swap.h`        | byte-swap functions for endian conversion
...
mulle-c11 is a component of the [mulle-core](//github.com/mulle-core/mulle-core) library. So in your code include the mulle-core umbrella header:
...
### Embed mulle-c11 with clib

``` sh
clib install --out src mulle-c/mulle-c11
```
